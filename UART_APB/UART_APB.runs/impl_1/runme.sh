...
HD_PWD='E:/Projects/Verilog/Projects/APB_UART/UART_APB/UART_APB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_APB_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UART_APB_TOP.tcl -notrace
