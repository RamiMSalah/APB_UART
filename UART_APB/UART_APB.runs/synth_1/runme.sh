...
HD_PWD='E:/Projects/Verilog/Projects/APB_UART/UART_APB/UART_APB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UART_APB_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UART_APB_TOP.tcl
