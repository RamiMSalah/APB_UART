...
rem %vlib_exec% C:/QFT_2021.1/QFT_2021.1/QFT/V2021.1/win64/bin/E:/Projects/Verilog/Projects/APB_UART/QUESTA_LINT/qcache/AN/zin_vopt_work
if %errorlevel% EQU 0 ( 
  %vmap_exec% -modelsimini modelsim.ini z0in_work_ctrl C:/QFT_2021.1/QFT_2021.1/QFT/V2021.1/win64/bin/E:/Projects/Verilog/Projects/APB_UART/QUESTA_LINT/qcache/AN/zin_vopt_work
) else (
  echo "** Error: Library mapping failed. (Command: 'vlib C:/QFT_2021.1/QFT_2021.1/QFT/V2021.1/win64/bin/E:/Projects/Verilog/Projects/APB_UART/QUESTA_LINT/qcache/AN/zin_vopt_work')"
)
