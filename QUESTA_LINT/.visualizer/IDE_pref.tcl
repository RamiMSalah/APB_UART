...
set perspective_DateTime   {2025-09-07T15:58:58}
set perspective_Directory  {E:/Projects/Verilog/Projects/APB_UART/QUESTA_LINT}
set perspective_USER       {Rami}
...
pref::set -type string -category General -name IDEVisibleWindows -value Lint###zinschematicview,zinlintMsgDashboardView,source,source,zindetails,transcript,zinflownavigator,zinlintDesignMetricsView,zinlintMsgStatusHistoryView,zincdcdutview,zinlintMsgSummaryView,zinmsgviewer,zinlintMsgView,source,zinlintDesignInfoView -hide -description none -label none
...
pref::set -type string -category Lint -name lintMessagesviewToolButtonFiltersTuple -value Check!-!Equals!-!case_default_missing!@!Severity!-!Equals!-!Error!@!State!-!Equals!-!open!@!Status!-!Equals!-!pending!@!Status!-!Equals!-!uninspected!@!Status!-!Equals!-!bug -hide -description none -label none
